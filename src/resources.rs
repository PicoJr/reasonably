...
use crate::format_decimal::{
    format_decimal_bugs, format_decimal_devs, format_decimal_features, format_decimal_hrs,
    format_decimal_loc, format_decimal_pms,
};
...
#[component]
pub(crate) fn Resources(state: Signal<State>) -> Element {
    rsx! {
        div {
            class: "resources",
            table {
